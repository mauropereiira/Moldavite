# Notomattic Design System - Comprehensive Analysis

## Overview
Notomattic v2 is a macOS native note-taking application built with React, TypeScript, and Tauri. It uses Tailwind CSS 4.1 as the primary styling framework with a custom theme system supporting both light and dark modes.
...
// Persisted via Zustand middleware (localStorage: 'notomattic-theme')
```
